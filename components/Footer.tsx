        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-zinc-600 mb-4">
              Omröstning online och skapa polls gratis utan inlogg, Verktyg för webbundersökningar, Gratis Online Direktomröstningar, Anordna en omröstning för att fatta ett beslut.
            </p>
          </div>
          <div>
